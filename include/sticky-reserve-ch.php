            ...
            <div class="reserve-block">
                <div class="row">
                    <div class="first col-xs-12">
                        <div class="info-block">
                            ...
                            <div class="copyright d-flex align-items-center">
                                ...
                                <a target="_blank" href="/ch/visasupport">
                                    获得签证邀请
                                </a>
                            </div>
                    ...
                    <div class="second col-xs-12">
                        ...
                        <form id="reserve-form" method="post" action="/ajax/reserve" class="reserve-form-sticky">
                        ...
                        <script>
                            ...
                            var btnSend = document.querySelector('reserve-form-sticky');
                            ...
                            btnSend.addEventListener('submit', function (e) {
                                ...
                                var pathName = '/ch/booking/?date=' + formatDateFrom + '&nights=' + nights + '&adults=' + selectedAdultsVal;
