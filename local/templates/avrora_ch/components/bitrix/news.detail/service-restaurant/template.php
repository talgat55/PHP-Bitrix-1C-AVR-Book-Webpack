...
<section class="menu-section">
    <div class="row">
        <div class="item col">
            <a href="<?=$arResult['DISPLAY_PROPERTIES']['BANKET_MENU']['FILE_VALUE']['SRC']; ?>"  target="_blank" class="wrapper">
                <div class="img-block">
        ...
        <div class="item col">
            <a href="<?=$arResult['DISPLAY_PROPERTIES']['MAIN_MENU']['FILE_VALUE']['SRC']; ?>"  target="_blank" class="wrapper">
                <div class="img-block">
        ...
        <div class="item col">
            <a href="<?=$arResult['DISPLAY_PROPERTIES']['BUSINES_MENU']['FILE_VALUE']['SRC']; ?>"  target="_blank" class="wrapper">
                <div class="img-block">
        ...
        <div class="item col">
            <a href="<?=$arResult['DISPLAY_PROPERTIES']['SWEDES_MENU']['FILE_VALUE']['SRC']; ?>"  target="_blank" class="wrapper">
                <div class="img-block">
