...
<head>
    ...
    <link rel="stylesheet" href="/local/templates/avrora_en/assets/src/css/travelline-style.css">
    <link rel="stylesheet" href="/local/templates/avrora_en/assets/src/css/datepicker.min.css">
    <script type="text/javascript" src="/local/templates/avrora_en/assets/src/js/datepicker.min.js"></script>
    <script type="text/javascript" src="/local/templates/avrora_en/assets/src/js/datepicker.en.js"></script>
...
<body class="<? $APPLICATION->ShowProperty('BodyClass'); ?>  en-version" <? $APPLICATION->ShowProperty('BodyTag'); ?> >
<?
