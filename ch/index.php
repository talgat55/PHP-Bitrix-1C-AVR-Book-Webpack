...
$APPLICATION->SetPageProperty("title","奧羅拉酒店,鄂木斯克 - 官方網站");
...
<div class="container">
	<div class="row d-flex align-items-center">
		<div class="first col-lg-7 col-xs-12">
			...
			<p>
				 Aurora是一家现代化的舒适酒店，符合所有质量标准，并获得3星级认证。 <br>
 <br>
				 独特的位置距离机场5分钟，距离中心和火车站10分钟，享有额尔齐斯河的美景，清新的空气和窗外最大的鄂木斯克公园。 <br>
 <br>
				 为您提供124间舒适的房间，从经济标准到行政套房。 <br>
 <br>
				 Aurora酒店的全景餐厅结合了由主厨Vitaly Mitin执行的欧洲，俄罗斯和原创美食。 <br>
 <br>
...
<div class="container">
	<div class="row">
		<div class="col-lg-12 col-xs-12">
			<h2 class="sub-title text-center w-100">服务<br>
 </h2>
		...
		<div class="feedback-block w-100">
			<div class="top d-flex align-items-center">
				<div class="col-lg-6 col-md-12 col-xs-12">
					...
					<p class="content">
						 我们会仔细阅读您的来信，并尽快回答您的问题。 <a href="/policy"> 隐私政策。</a>
					</p>
				</div>
				<div class="col-lg-6 col-md-12 col-xs-12">
