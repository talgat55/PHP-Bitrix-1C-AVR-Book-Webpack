...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-lg-8 col-xs-12">
			<p class="text-center">
				 Гостиница «Аврора» – это три современных комфортабельных конференц-зала и бизнес-центр, которые идеально подходят для проведения тренингов, семинаров, пресс-конференций, различных деловых встреч, веб-конференций. <br>
 <br>
				 Залы оснащены системой кондиционирования и имеют высокоскоростной Интернет доступ <br>
				 (Wi-Fi).
			</p>
...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"PROPERTY_CODE" => array(0=>"SIZE",1=>"OPTIONS",2=>"SLIDERS",3=>"",),
		"SET_BROWSER_TITLE" => "N",
		"SET_LAST_MODIFIED" => "N",
...
<div class="container">
	...
	<div class="row">
		<div class="content">
			<p class="description text-center">
				 В качестве приятного дополнения любого делового мероприятия ресторан «Аврора» предлагает широкий выбор меню кофе-пауз, бизнес-ланчей, фуршетов, банкетов.
			</p>
 ...
 <a href="/КОФЕ%20БРЕЙК%20НОВЫЙ.pdf" target="_blank" class="menu-section wrapper">
					<div class="img-block">
 ...
 </section> <section class="footer-sliders">
<div class="container">
	<div class="row">
	...
	Array(
		...
		"PARENT_SECTION_CODE" => "",
		"PREVIEW_TRUNCATE_LEN" => "",
		"PROPERTY_CODE" => array(0=>"",1=>"SLIDERS",2=>"",),
		"SET_BROWSER_TITLE" => "N",
		"SET_LAST_MODIFIED" => "N",
		"SET_META_DESCRIPTION" => "N",
		"SET_META_KEYWORDS" => "N",
